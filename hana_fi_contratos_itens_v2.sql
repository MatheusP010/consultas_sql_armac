...
SELECT
	...
	TO_DATE(dtitem.VBEGDAT, 'YYYY-MM-DD') as "Data Inicio Item",
	TO_DATE(dtitem.VENDDAT, 'YYYY-MM-DD') as "Data Fim Item",
	TO_DATE(dtitem.VDEMDAT, 'YYYY-MM-DD') as "Data Desmont. Item",
