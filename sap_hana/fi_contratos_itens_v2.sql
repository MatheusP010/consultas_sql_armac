...
SELECT
	...
	TO_DATE(COALESCE(dtitem.VBEGDAT, dtcbc.vbegdat), 'YYYY-MM-DD') AS "Data Inicio Item",
	TO_DATE(COALESCE(dtitem.VENDDAT, dtcbc.venddat), 'YYYY-MM-DD') AS "Data Fim Item",
	TO_DATE(COALESCE(dtitem.VDEMDAT, dtcbc.vdemdat), 'YYYY-MM-DD') AS "Data Desmont. Item",
